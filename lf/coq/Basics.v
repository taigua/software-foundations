...
Proof. reflexivity. Qed.
Example test_bin_incr3 : incr (B (A (B Z))) = A (B (B Z)).
Proof. reflexivity. Qed.

Example test_bin_to_nat1 : bin_to_nat Z = O.
Proof. reflexivity. Qed.
Example test_bin_to_nat2 : bin_to_nat (B Z) = S 0.
Proof. reflexivity. Qed.
Example test_bin_to_nat3 : bin_to_nat (B (A (B Z))) = S (S (S (S (S O)))).
Proof. reflexivity. Qed.
